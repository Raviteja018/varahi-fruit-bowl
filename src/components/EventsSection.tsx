...
export const EventsSection: React.FC<EventsSectionProps> = ({ onPlanEventOrder }) => {
  const getIcon = (type: string) => {
    switch (type) {
      ...
      default: return <Sliders className="w-6 h-6 text-citrus-dark" />;
    }
  };

  return (
    <section id="events" className="py-24 sm:py-32 bg-cream-100 relative overflow-hidden border-t border-forest-900/10">
          ...
          <div className="rounded-3xl bg-gradient-to-br from-emerald-800 to-forest-950 text-white p-7 sm:p-8 shadow-xl flex flex-col justify-between md:col-span-2 lg:col-span-1">
            <div>
              <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center mb-5">
                <WhatsAppIcon className="w-6 h-6 text-citrus-yellow" />
              </div>
